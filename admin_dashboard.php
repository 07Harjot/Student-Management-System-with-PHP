					...
					while ($row = mysqli_fetch_assoc($query_run)) 
					{
						...
						<table>
							...
							<tr>
								...
								<td>
									<textarea rows="3" cols="40" disabled><?php echo $row['task assigned']?></textarea>
								</td>
							</tr>
						</table>
						<?php
				...
				while ($row = mysqli_fetch_assoc($query_run)) 
				{
					...
					<form action="admin_edit_student.php" method="post">
						...
						<tr>
							...
							<td>
								<textarea rows="3" cols="40" name="task assigned"><?php echo $row['task assigned']?></textarea>
							</td>
						</tr><br>
						<tr>
							<td></td>
				...
				if(isset($_POST['add_new_student'])){
					...
					<form action="add_student.php" method="post">
						...
						<tr>
							...
							<td>
								<textarea rows="3" cols="40" placeholder="Optional" name="task assigned"></textarea>
							</td>
						</tr>
						<tr>
							<td></td>
